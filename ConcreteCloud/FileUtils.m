...
+ (BOOL)renameFileNameInPath:(NSString *)dirPath oldName:(NSString *)oldName toNewName:(NSString *)newName
{
    ...
    NSString *filePath = [dirPath stringByAppendingPathComponent:oldName];
    NSString *newFilePath = [dirPath stringByAppendingPathComponent:newName];
    NSFileManager *manager = [NSFileManager defaultManager];
...
+ (BOOL)copyFilesFrom:(NSString *)sourcePath to:(NSString *)destinationPath fileName:(NSString *)name
{
    ...
    NSString *filePath = [destinationPath stringByAppendingPathComponent:name];
