...
@interface PDetailController()<UITableViewDelegate, UITableViewDataSource>
{
    //公共属性起始index
    NSInteger _dyIndex;
}
...
@implementation PDetailController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (_dyIndex + 4 == indexPath.row)
    {
        KeyValueCell *cell = [KeyValueCell viewFromNib];
        cell.lbKey.text = @"联系人";
        cell.lbValue.text = _orderInfo.administratorName;
    ...
    else if (_dyIndex + 5 == indexPath.row)
    {
        ...
        cell.lbValue.text = _orderInfo.administratorTel;
    ...
    else if (_dyIndex + 6 == indexPath.row)
    {
        KeyValueCell *cell = [KeyValueCell viewFromNib];
        cell.lbKey.text = @"地址";
        cell.lbValue.text = _orderInfo.supplierAddress;
