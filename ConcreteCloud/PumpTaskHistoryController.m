...
@interface PumpTaskHistoryController()<UITableViewDelegate, UITableViewDataSource, PullTableViewDelegate>
{
...
@implementation PumpTaskHistoryController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.lbPlate.text = info.hzs_Order.siteName;
