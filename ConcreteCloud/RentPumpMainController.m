...
@implementation RentPumpMainController
...
- (void)initItem
{
    ...
    RentPumpProcessController *process = [[RentPumpProcessController alloc] init];
    
    UIViewController *history = [[RentPumpHistoryController alloc] init];
    
    UIViewController *vehicle = [[RentPumpInfoController alloc] init];
...
- (void)initTabBar
{
    ...
    [[tabBar.items objectAtIndex:0] setImage:[UIImage imageNamed:@"icon_process"]];
    ...
    [[tabBar.items objectAtIndex:2] setImage:[UIImage imageNamed:@"icon_renter"]];
