...
@interface RentTankerHistoryController()<UITableViewDelegate, UITableViewDataSource, PullTableViewDelegate>
{
...
@implementation RentTankerHistoryController
